...
STUDENT_TEST("Test Order") {
    EXPECT_EQUAL(aSequenceOfOrder(5), "ABBABAABBAABABBABAABABBAABBABAAB");
    EXPECT_EQUAL(bSequenceOfOrder(5), "BAABABBAABBABAABABBABAABBAABABBA");
